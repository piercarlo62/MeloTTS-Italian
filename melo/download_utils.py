...
DOWNLOAD_CKPT_URLS = {
    ...
    'IT': 'https://myshell-public-repo-host.s3.amazonaws.com/openvoice/basespeakers/IT/checkpoint.pth',
...
DOWNLOAD_CONFIG_URLS = {
    ...
    'IT': 'https://myshell-public-repo-host.s3.amazonaws.com/openvoice/basespeakers/IT/config.json',
